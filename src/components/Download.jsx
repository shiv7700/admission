...
const Download = () => {
  return (
    ...
    <div> <img className='w-[29rem]' src={mob} alt="" /> </div>

    <div className='mt-10'>

        <div>
            <h1 className='text-5xl font-bold'>Download App</h1>
            <p className='text-xl mt-3 mb-10'>Lorem ipsum is placeholder text commonly used in the <br /> graphic, print, and publishing industries for previewing <br /> layouts and visual mockups.</p>
        </div>

        <div> <img className='w-[30rem]' src={mob2} alt="" /> </div>
        ...
        <div className='send mt-10'>
            ...
            <div className='flex mt-4'>
                <div> <input className='p-2 w-[28rem] border-[1px] border-black' type="text" placeholder='Enter your mobile number*' /> </div>
