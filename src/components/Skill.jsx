...
const Skill = () => {
  return (
    <div className='skill-container w-[100%] flex flex-wrap justify-around pt-16'>
        ...
        <div className='mt-8 mb-10'> <input className='search-for p-2 w-[16rem] sm:w-[30rem] rounded' type="text" placeholder='Search for University, Colleges & Courses' /> </div>

        <div className='flex flex-wrap space-x-4 mb-5 lg:mb-0'>
            ...
            <div className='p-2 text-[#311C61] font-medium bg-white flex space-x-2 rounded i-2 hover:cursor-pointer hover:bg-[#FFA200] mt-5 sm:mt-0'>
        ...
        <div> <img className='w-[15rem]' src={cc1} alt="" /> <div className='gradient-bg text-center text-xs p-3 font-semibold rounded-lg relative -top-52 right-40'>Lorem ipsum is placeholder <br /> text commonly used in</div>  </div>

        <div className='flex flex-wrap flex-col'>

        <div> <img className='w-[10rem] -mt-10' src={cc2} alt="" /> <div className='gradient-bg text-center text-xs p-2 font-semibold rounded-lg relative -top-32 right-32'>Lorem ipsum is placeholder <br /> text commonly used in</div> </div>

        <div> <img className='w-[10rem] mt-20' src={cc3} alt="" /> <div className='gradient-bg text-center text-xs p-2 font-semibold rounded-lg relative -top-32 right-32'>Lorem ipsum is placeholder <br /> text commonly used in</div> </div>
